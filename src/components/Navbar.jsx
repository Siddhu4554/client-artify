      ...
      <div>
        {
            user ?
                <div className='flex items-center gap-2 sm:gap-3'>
                    <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 hover:rotate-2 transition-all duration-700'>
                        <img src={assets.credit_star} alt='Buy Credits' className='w-5' />
